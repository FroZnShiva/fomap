...
var i_Airfield = L.icon({
	iconUrl: '../markers/Airfield.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_BoS = L.icon({
	iconUrl: '../markers/BoS.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Brownstone = L.icon({
	iconUrl: '../markers/Brownstone.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Bunker = L.icon({
	iconUrl: '../markers/Bunker.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_BunkerHill = L.icon({
	iconUrl: '../markers/BunkerHill.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
...
var i_Car = L.icon({
	iconUrl: '../markers/Car.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Castle = L.icon({
	iconUrl: '../markers/Castle.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Cave = L.icon({
	iconUrl: '../markers/Cave.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Church = L.icon({
	iconUrl: '../markers/Church.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
...
var i_CountryClub = L.icon({
	iconUrl: '../markers/CountryClub.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_CustomHouse = L.icon({
	iconUrl: '../markers/CustomHouse.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_DiamondCity = L.icon({
	iconUrl: '../markers/DiamondCity.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_DriveIn = L.icon({
	iconUrl: '../markers/DriveIn.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_ElevatedHighway = L.icon({
	iconUrl: '../markers/ElevatedHighway.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Encampment = L.icon({
	iconUrl: '../markers/Encampment.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Factory = L.icon({
	iconUrl: '../markers/Factory.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_FaneuilHall = L.icon({
	iconUrl: '../markers/FaneuilHall.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Farm = L.icon({
	iconUrl: '../markers/Farm.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_FillingStation = L.icon({
	iconUrl: '../markers/FillingStation.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Forested = L.icon({
	iconUrl: '../markers/Forested.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Goodneighbor = L.icon({
	iconUrl: '../markers/Goodneighbor.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Graveyard = L.icon({
	iconUrl: '../markers/Graveyard.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
...
var i_IndustrialDome = L.icon({
	iconUrl: '../markers/IndustrialDome.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_IndustrialStacks = L.icon({
	iconUrl: '../markers/IndustrialStacks.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Institute = L.icon({
	iconUrl: '../markers/Institute.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_IrishPride = L.icon({
	iconUrl: '../markers/IrishPride.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Junkyard = L.icon({
	iconUrl: '../markers/Junkyard.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Landmark = L.icon({
	iconUrl: '../markers/Landmark.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Libertalia = L.icon({
	iconUrl: '../markers/Libertalia.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_LowRise = L.icon({
	iconUrl: '../markers/LowRise.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Mechanist = L.icon({
	iconUrl: '../markers/Mechanist.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
...
var i_MilitaryBase = L.icon({
	iconUrl: '../markers/MilitaryBase.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Minutemen = L.icon({
	iconUrl: '../markers/Minutemen.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Monument = L.icon({
	iconUrl: '../markers/Monument.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Observatory = L.icon({
	iconUrl: '../markers/Observatory.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
...
var i_Pier = L.icon({
	iconUrl: '../markers/Pier.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_PoliceStation = L.icon({
	iconUrl: '../markers/PoliceStation.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_PondLake = L.icon({
	iconUrl: '../markers/PondLake.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_PotentitalVassalSettlement = L.icon({
	iconUrl: '../markers/PotentitalVassalSettlement.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Prydwen = L.icon({
	iconUrl: '../markers/Prydwen.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Quarry = L.icon({
	iconUrl: '../markers/Quarry.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_RadioactiveArea = L.icon({
	iconUrl: '../markers/RadioactiveArea.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_RadioTower = L.icon({
	iconUrl: '../markers/RadioTower.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_RaiderSettlement = L.icon({
	iconUrl: '../markers/RaiderSettlement.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Railroad = L.icon({
	iconUrl: '../markers/Railroad.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_RailroadFaction = L.icon({
	iconUrl: '../markers/RailroadFaction.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Salem = L.icon({
	iconUrl: '../markers/Salem.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_SancHills = L.icon({
	iconUrl: '../markers/SancHills.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Satellite = L.icon({
	iconUrl: '../markers/Satellite.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
...
var i_Sentinel = L.icon({
	iconUrl: '../markers/Sentinel.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Settlement = L.icon({
	iconUrl: '../markers/Settlement.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Sewer = L.icon({
	iconUrl: '../markers/Sewer.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Shipwreck = L.icon({
	iconUrl: '../markers/Shipwreck.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Skyscraper = L.icon({
	iconUrl: '../markers/Skyscraper.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Submarine = L.icon({
	iconUrl: '../markers/Submarine.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_SwanPond = L.icon({
	iconUrl: '../markers/SwanPond.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_SynthHead = L.icon({
	iconUrl: '../markers/SynthHead.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
...
var i_TownRuins = L.icon({
	iconUrl: '../markers/TownRuins.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_UrbanRuins = L.icon({
	iconUrl: '../markers/UrbanRuins.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_USSConstitution = L.icon({
	iconUrl: '../markers/USSConstitution.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_VassalSettlement = L.icon({
	iconUrl: '../markers/VassalSettlement.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
var i_Vault = L.icon({
	iconUrl: '../markers/Vault.png',
	iconSize: isize,
	iconAnchor: ianchor,
	popupAnchor: panchor,
});
...
var locale = {
	"en": {
		...
		"markerData": [{
				title: "Acadia",
				page: "Acadia_(location)"
			}, {
				title: "Aldersea Day Spa",
				page: "Aldersea_Day_Spa"
			}, {
				title: "Beaver Creek Lanes",
				page: "Beaver_Creek_Lanes"
			}, {
				title: "Brooke's Head Lighthouse",
				page: "Brooke's_Head_Lighthouse"
			}, {
				title: "Cliff's Edge Hotel",
				page: "Cliff's_Edge_Hotel"
			}, {
				title: "Dalton Farm",
				page: "Dalton_Farm"
			}, {
				...
				page: "Southwest_Harbor"
			}, {
				title: "Atom's Spring",
				page: "Atom's_Spring"
			}, {
				title: "Old Pond House",
				page: "Old_Pond_House"
			}, {
				title: "Children of Atom Shrine",
				page: "Children_of_Atom_Shrine"
			}, {
				title: "Ruined Church",
				page: "Ruined_Church"
			}, {
				title: "Radiant Crest Shrine",
				page: "Radiant_Crest_Shrine"
			}, {
				title: "Glowing Grove",
				page: "Glowing_Grove"
			}, {
				title: "Briney's Bait and Tackle",
				page: "Briney's_Bait_and_Tackle"
			}, {
				title: "Waves Crest Orphanage",
				page: "Waves_Crest_Orphanage"
			}, {
				title: "Oceanarium",
				page: "Oceanarium"
			}, {
				title: "Eagle's Cove Tannery",
				page: "Eagle's_Cove_Tannery"
			}, {
				title: "Echo Lake Lumber",
				page: "Echo_Lake_Lumber"
			}, {
				title: "Eden Meadows Cinemas",
				page: "Eden_Meadows_Cinemas"
			}, {
				title: "Far Harbor",
				page: "Far_Harbor"
			}, {
				title: "Fringe Cove Docks",
				page: "Fringe_Cove_Docks"
			}, {
				title: "Haddock Cove",
				page: "Haddock_Cove"
			}, {
				title: "Harbor Grand Hotel",
				page: "Harbor_Grand_Hotel"
			}, {
				title: "Horizon Flight 1207",
				page: "Horizon_Flight_1207"
			}, {
				title: "Kitteredge Pass",
				page: "Kitteredge_Pass"
			}, {
				title: "Longfellow's Cabin",
				page: "Longfellow's_Cabin"
			}, {
				title: "MS Azalea",
				page: "MS_Azalea"
			}, {
				title: "National Park Campground",
				page: "National_Park_Campground"
			}, {
				title: "National Park HQ",
				page: "National_Park_HQ"
			}, {
				title: "National Park Visitor's Center",
				page: "National_Park_Visitor's_Center"
			}, {
				title: "Northwood Ridge Quarry",
				page: "Northwood_Ridge_Quarry"
			}, {
				title: "The Nucleus",
				page: "The_Nucleus"
			}, {
				title: "Pine Crest Cavern",
				page: "Pine_Crest_Cavern"
			}, {
				title: "Rayburn Point",
				page: "Rayburn_Point"
			}, {
				title: "Rock Point Camp",
				page: "Rock_Point_Camp"
			}, {
				title: "Ruined Radio Tower",
				page: "Ruined_Radio_Tower"
			}, {
				title: "Vim! Pop Factory",
				page: "Vim!_Pop_Factory"
			}, {
				title: "Huntress Island",
				page: "Huntress_Island"
			}, {
				title: "Cranberry Island Supply Shed",
				page: "Cranberry_Island_Supply_Shed"
			}, {
				title: "Cranberry Island Bog",
				page: "Cranberry_Island_Bog"
			}, {
				title: "Cranberry Island Docks",
				page: "Cranberry_Island_Docks"
			}, {
				title: "Wind Farm Maintenance",
				page: "Wind_Farm_Maintenance"
			}, {
				title: "Zephyr Ridge Camp",
				page: "Zephyr_Ridge_Camp"
			},

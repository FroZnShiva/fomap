...
// Then, similar to GameX, we take the inverted GameY and multiply it by 0.2421875, to get the pixel distance - then add it to the 32272 distance. 
      	...
      	var markerData=[{x:32371.0253,y:36810.0800,icon:i_TownRuins,},
{x:31537.3637,y:36835.6535,icon:i_Pack,},
{x:33653.0298,y:30826.3088,icon:i_Rides,},
{x:32590.1503,y:35404.2575,icon:i_Operators,},
{x:33109.5279,y:33507.4124,icon:i_Disciples,},
{x:32408.1095,y:33453.2050,icon:i_RaiderSettlement,},
{x:41667.0945,y:22285.6567,icon:i_TownRuins,},
{x:37011.5984,y:18021.3573,icon:i_PondLake,},
{x:39495.3580,y:20900.0027,icon:i_TownRuins,},
{x:39473.7482,y:28646.5764,icon:i_ElevatedHighway,},
{x:36163.1929,y:29005.4687,icon:i_Rides,},
{x:35047.6815,y:28912.7764,icon:i_Rides,},
{x:31686.9931,y:23596.4502,icon:i_Safari,},
{x:30864.0898,y:21228.2500,icon:i_Safari,},
{x:30856.1133,y:22840.2500,icon:i_Cave,},
{x:32871.4911,y:23885.9059,icon:i_Safari,},
{x:22464.7247,y:39899.7899,icon:i_Encampment,},
{x:37805.2430,y:24367.7195,icon:i_FillingStation,},
{x:17985.3737,y:30743.6122,icon:i_IndustrialDome,},
{x:24091.7614,y:41604.0577,icon:i_Rides,},
{x:29071.9842,y:28738.0147,icon:i_Office,},
{x:30532.3916,y:28502.1295,icon:i_TownRuins,},
{x:29292.4385,y:27106.3620,icon:i_Rides,},
{x:38225.0364,y:35983.6634,icon:i_Monument,},
{x:32015.5324,y:43700.9937,icon:i_Encampment,},
{x:35147.5051,y:29708.3654,icon:i_Town,},
{x:28300.6751,y:27690.7340,icon:i_Office,},
{x:31782.5047,y:23078.5284,icon:i_Safari,},
{x:32404.6088,y:37465.4172,icon:i_TownRuins,},
{x:35270.8393,y:25365.3664,icon:i_Factory,},
{x:34871.7643,y:26578.9831,icon:i_Monument,},
{x:28008.3305,y:40655.5190,icon:i_Encampment,},
{x:23473.8047,y:37084.7500,icon:i_Junkyard,},
{x:27920.3678,y:32990.1632,icon:i_Rides,},
{x:27205.8379,y:31758.7158,icon:i_Rides,},
{x:28929.9979,y:31775.0627,icon:i_Rides,},
{x:28006.4464,y:34127.9557,icon:i_Rides,},
{x:28879.0748,y:33909.6657,icon:i_Rides,},
{x:28450.9226,y:32901.2277,icon:i_Galactic,},
{x:33532.2500,y:36767.0000,icon:i_Rides,},
{x:33245.0938,y:40386.2500,icon:i_Monorail,},
];
...
var locale={
	"en":{
		...
		"markerData":[
			{title:"Nuka-Town Market",page:"Nuka-Town_market"},
			{title:"Bradberton Amphitheater",page:"Bradberton_Amphitheater"},
			//{title:"Moonshiner's Camp",page:"Moonshiner's_camp"},
			{title:"Ferris Wheel",page:"Ferris_Wheel_(Nuka-World)"},
			{title:"The Parlor",page:"The_Parlor"},
			{title:"Fizztop Mountain",page:"Fizztop_Mountain"},
			{title:"Fizztop Grille",page:"Fizztop_Grille"},
			{title:"Morton residence",page:"Morton_residence"},
			{title:"Northpoint Reservoir",page:"Northpoint_reservoir"},
			//{title:"Nuka-World Airfield",page:"Nuka-World_Airfield"},
			{title:"Bradberton",page:"Bradberton"},
			{title:"Bradberton Overpass",page:"Bradberton_overpass"},
			{title:"King Cola's Castle",page:"King_Cola's_Castle"},
			{title:"Fun House",page:"Fun_House"},
			{title:"Cappy's Treehouse",page:"Cappy's_treehouse"},
			{title:"The Angry Anaconda",page:"Angry_Anaconda"},
			{title:"Safari Adventure Reptile House",page:"Safari_Adventure_reptile_house"},
			{title:"Safari Adventure Primate House",page:"Safari_Adventure_primate_house"},
			{title:"Dunmore Homestead",page:"Dunmore_homestead"},
			{title:"Nuka-World Red Rocket",page:"Nuka-World_Red_Rocket"},
			{title:"Nuka-World Power Plant",page:"Nuka-World_power_plant"},
			{title:"Grandchester Mystery Mansion",page:"Grandchester_Mystery_Mansion"},
			{title:"Dry Rock Gulch Theater",page:"Dry_Rock_Gulch_Theater"},
			{title:"Dry Rock Gulch Employee Area",page:"Dry_Rock_Gulch_employee_area"},
			{title:"Mad Mulligan's Minecart Coaster",page:"Mad_Mulligan's_Minecart_Coaster"},
			{title:"Wixon's Shovel Museum",page:"Wixon's_shovel_museum"},
			{title:"Evan's Home",page:"Evan's_home"},
			{title:"Kiddie Kingdom",page:"Kiddie_Kingdom"},
			{title:"Doc Phosphate's Saloon",page:"Doc_Phosphate's_Saloon"},
			{title:"Safari Adventure",page:"Safari_Adventure"},
			{title:"Nuka-Town USA",page:"Nuka-Town_USA"},
			{title:"Nuka-Cola Bottling Plant",page:"Nuka-Cola_bottling_plant"},
			{title:"World of Refreshment",page:"World_of_Refreshment"},
			{title:"Hubologist's Camp",page:"Hubologist's_camp"},
			{title:"Nuka-World Junkyard",page:"Nuka-World_junkyard"},
			{title:"Starport Nuka",page:"Starport_Nuka"},
			{title:"Nuka-Galaxy",page:"Nuka-Galaxy"},
			{title:"RobCo Battlezone",page:"RobCo_Battlezone"},
			{title:"Vault-Tec: Among the Stars",page:"Vault-Tec:_Among_the_Stars"},
			{title:"Starlight Interstellar Theater",page:"Starlight_Interstellar_Theater"},
			{title:"Galactic Zone",page:"Galactic_Zone"},
			{title:"Cola-Cars Arena",page:"Cola-cars_arena"},
			{title:"Nuka-Station",page:"Nuka-station"},
...
var childMapData=[
	...
	{width:6144,height:8192,zoom:3},*/
      	...
      	function init()
      	{
      		...
      		L.tileLayer('/fo4maps/nukaworld/{z}/{x}_{y}.png', {
      			continuousWorld: 'true',
